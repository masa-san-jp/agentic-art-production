...
class DocumentationContractTests(unittest.TestCase):
    ...
    def test_schema_reference_matches_registry(self) -> None:
        ...
        for schema_id in ("production-project", "production-plan", "prototype-control", "runtime-event", "runtime-state", "output-version", "quality-result", "installation-result", "production-result"):
